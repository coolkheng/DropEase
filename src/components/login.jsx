            ...
            <div className={styles.login_form_container}>
                <div className={styles.left}>
                    ...
                    <div className={styles.left_box}>
                        <form className={styles.form_container} onSubmit={handleSubmit}>
                            ...
                            {errorMessage && (
                                <div className={styles.error_container}>
                                    ...
                                    <button className={styles.close_button} onClick={handleCloseError}>
                                        <img src={require('../asset/close-icon.png')} alt="Close" className={styles.close_icon} />
                                    </button>
                                </div>
                            ...
                            <div className={styles.remember_me}>
                                ...
                                <Link to="/forgotpw" className={styles.forgot_password}>Forgot Password?</Link>
                            </div>
                            {/* Dropdown button for Retailer or Customer selection */}
                            <select className={styles.dropdown} id="user_type" name="user_type">
                        ...
                        <button type="button" className={`${styles.white_btn_three} ${styles.continue_with_google}`}>
                            Continue with Google
                        </button>

                        <button type="button" className={`${styles.white_btn_three} ${styles.continue_with_facebook}`}>
                            Continue with Facebook
                        </button>

                        <button type="button" className={`${styles.white_btn_three} ${styles.continue_with_apple}`}>
                            Continue with Apple
                        </button>
                    </div>
                </div>
